...
class ItemScreen extends StatefulWidget {
  final Map args;
  const ItemScreen({Key? key, required this.args}) : super(key: key);
...
class _ItemScreenState extends State<ItemScreen> with TickerProviderStateMixin {
  ...
  Future<void> readJson() async {
    ...
    setState(() {
      ...
      itemBrand = data[itemTitle]['itemBrand'];
      itemReview = data[itemTitle]['itemReview'];
      itemImage = data[itemTitle]['itemImages'][0];
              ...
              Column(children: [
                ...
                Expanded(
                  ...
                  child: [
                    ...
                    CompareItemScreen(
                        itemTitle: itemTitle, emailName: emailName),
                  ][controller.index],
                )))
              ]),
              Visibility(
